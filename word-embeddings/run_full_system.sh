...
python train.py --corpus-file ecosystem-sentences.txt --checkpoint-prefix model_eco --save-frequency 100 --display-frequency 25 --epochs 200 --model-checkpoint results/model_initial-0100.tar
