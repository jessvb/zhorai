...
var sentences = {
    ...
    beaver: [
        ...
        "Beavers can withstand the cold", 
        "Beavers are often active throughout winter and maintain use of their ponds even when they are covered with a layer of ice",
        "Beavers are good house guests",
        "Their lodges typically contain two dens, one for drying off after entering the lodge under water, and a second, dryer den where the family will live and socialize",
        "Beavers have an excellent sense of smell",
        "Beavers are herbivores, so they eat plants, just like vegetarians",
